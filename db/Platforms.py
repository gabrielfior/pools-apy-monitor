...
class Pools(Enum):
    ...
    PANCAKE_SWAP_MANUAL_CAKE = PoolWrapper('pancakeswap', '0x73feaa1eE314F8c655E354234017bE2193C9E24E', Networks.BSC_MAIN.value)
    PANCAKE_SWAPAUTO_CAKE = PoolWrapper('pancakeswap', '0xa80240Eb5d7E05d3F250cF000eEc0891d00b51CC', Networks.BSC_MAIN.value)
